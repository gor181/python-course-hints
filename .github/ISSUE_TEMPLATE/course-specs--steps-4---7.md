---
name: 'Course Specs: Steps 4 - 7'
about: 'Template for Course Specs: Steps 4 - 7'

---

### Step 4: Capstone Exercises
- [ ] Is there **one** capstone exercise per chapter?
- [ ] Do the capstone exercises meet our [content guidelines](https://instructor-support.datacamp.com/courses/course-development/content-guidelines)?
...
- [ ] Does the code incorporate a relevant dataset that is [not overused](https://instructor-support.datacamp.com/frequently-asked-questions-faq/datasets/datasets-to-avoid)?
...
- [ ] Are the [Content Guidelines](https://instructor-support.datacamp.com/courses/course-development/content-guidelines) met?
